...
go
create table [Articulos.Marca](
	IdArticulo int not null,
	IdMarca int not null,
	CONSTRAINT FK_ArticulosMarca_IdArticulo FOREIGN KEY(IdArticulo) REFERENCES Articulos(Id),
	CONSTRAINT FK_ArticulosMarca_IdMarca FOREIGN KEY(IdMarca) REFERENCES Marcas(Id)
);
go
create table Users(
	Id int PRIMARY KEY not null,
